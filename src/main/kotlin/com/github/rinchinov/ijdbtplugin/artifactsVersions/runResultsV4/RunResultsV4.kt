package com.github.rinchinov.ijdbtplugin.artifactsVersions.runResultsV4
...
data class RunResultsV4 (
    ...
    companion object {
        fun fromJson(json: String) = mapper.readValue<RunResultsV4>(json)
    }
}

/**
 * BaseArtifactMetadata(dbt_schema_version: str, dbt_version: str = '1.0.0b2', generated_at:
