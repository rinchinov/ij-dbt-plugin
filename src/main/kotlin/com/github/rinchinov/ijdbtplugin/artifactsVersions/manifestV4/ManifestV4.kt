package com.github.rinchinov.ijdbtplugin.artifactsVersions.manifestV4
...
val mapper = jacksonObjectMapper().apply {
    ...
    convert(CheckCols::class,            { CheckCols.fromJson(it) },                      { it.toJson() }, true)
...
data class ManifestV4 (
    ...
    companion object {
        fun fromJson(json: String) = mapper.readValue<ManifestV4>(json)
    }
}
 ...
 * dbt.contracts.graph.model_config.NodeConfig = <factory>, tags: List[str] = <factory>,
 * refs: List[List[str]] = <factory>, sources: List[List[str]] = <factory>, depends_on:
 ...
 * compiled_sql: Union[str, NoneType] = None, extra_ctes_injected: bool = False, extra_ctes:
 ...
 * str, original_file_path: str, name: str, resource_type: dbt.node_types.NodeType, alias:
 * str, checksum: dbt.contracts.files.FileHash, config:
 * dbt.contracts.graph.model_config.TestConfig = <factory>, tags: List[str] = <factory>,
 * refs: List[List[str]] = <factory>, sources: List[List[str]] = <factory>, depends_on:
 * dbt.contracts.graph.parsed.DependsOn = <factory>, description: str = '', columns:
 * Dict[str, dbt.contracts.graph.parsed.ColumnInfo] = <factory>, meta: Dict[str, Any] =
 * <factory>, docs: dbt.contracts.graph.unparsed.Docs = <factory>, patch_path: Union[str,
 ...
 * original_file_path: str, name: str, resource_type: dbt.node_types.NodeType, alias: str,
 * checksum: dbt.contracts.files.FileHash, config:
 * dbt.contracts.graph.model_config.SeedConfig = <factory>, tags: List[str] = <factory>,
 * refs: List[List[str]] = <factory>, sources: List[List[str]] = <factory>, depends_on:
 * dbt.contracts.graph.parsed.DependsOn = <factory>, description: str = '', columns:
 * Dict[str, dbt.contracts.graph.parsed.ColumnInfo] = <factory>, meta: Dict[str, Any] =
 * <factory>, docs: dbt.contracts.graph.unparsed.Docs = <factory>, patch_path: Union[str,
 ...
 * float = <factory>, config_call_dict: Dict[str, Any] = <factory>, index: Union[int,
 * NoneType] = None)
 *
 ...
 * NoneType] = None, compiled_path: Union[str, NoneType] = None, build_path: Union[str,
 * NoneType] = None, deferred: bool = False, unrendered_config: Dict[str, Any] = <factory>,
 * created_at: float = <factory>, config_call_dict: Dict[str, Any] = <factory>, column_name:
 ...
 * original_file_path: str, name: str, resource_type: dbt.node_types.NodeType, alias: str,
 * checksum: dbt.contracts.files.FileHash, config:
 * dbt.contracts.graph.model_config.SnapshotConfig, tags: List[str] = <factory>, refs:
 ...
 * resource_type: dbt.node_types.NodeType, quoting: dbt.contracts.graph.unparsed.Quoting =
 * <factory>, loaded_at_field: Union[str, NoneType] = None, freshness:
 * Union[dbt.contracts.graph.unparsed.FreshnessThreshold, NoneType] = None, external:
 * Union[dbt.contracts.graph.unparsed.ExternalTable, NoneType] = None, description: str =
 * '', columns: Dict[str, dbt.contracts.graph.parsed.ColumnInfo] = <factory>, meta:
 * Dict[str, Any] = <factory>, source_meta: Dict[str, Any] = <factory>, tags: List[str] =
 * <factory>, config: dbt.contracts.graph.model_config.SourceConfig = <factory>, patch_path:
 * Union[pathlib.Path, NoneType] = None, unrendered_config: Dict[str, Any] = <factory>,
 * relation_name: Union[str, NoneType] = None, created_at: float = <factory>)
 */
 ...
 * = None, on_schema_change: Union[str, NoneType] = 'ignore')
 *
 ...
 * List[dbt.contracts.graph.model_config.Hook] = <factory>, quoting: Dict[str, Any] =
 * <factory>, column_types: Dict[str, Any] = <factory>, full_refresh: Union[bool, NoneType]
 * = None, on_schema_change: Union[str, NoneType] = 'ignore', quote_columns: Union[bool,
 * NoneType] = None)
 *
 ...
 * List[dbt.contracts.graph.model_config.Hook] = <factory>, quoting: Dict[str, Any] =
 * <factory>, column_types: Dict[str, Any] = <factory>, full_refresh: Union[bool, NoneType]
 * = None, on_schema_change: Union[str, NoneType] = 'ignore', strategy: Union[str, NoneType]
 * = None, unique_key: Union[str, NoneType] = None, target_schema: Union[str, NoneType] =
...
sealed class CheckCols {
    class StringArrayValue(val value: List<String>) : CheckCols()
    class StringValue(val value: String)            : CheckCols()
    class NullValue()                               : CheckCols()
    ...
    companion object {
        fun fromJson(jn: JsonNode): CheckCols = when (jn) {
