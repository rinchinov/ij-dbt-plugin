...
class DummyQueryExecutionManager(override val project: Project): QueryExecutionJdbcManagerInterface {
    ...
    override val jdbcUriType = QueryExecutionJdbcManagerInterface.JdbcUriType.AS_IS
}
